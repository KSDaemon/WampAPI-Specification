...
* Open an Issue at <https://github.com/KSDaemon/WampAPI-Specification/issues>
* Provide as much context as you can about what you're running into.
* Provide languages, project and platform versions, depending on what seems relevant. If not, please be ready to
...
So you want to contribute some code! That's great! This project uses GitHub Pull Requests to manage contributions,
...
* Go to <https://github.com/KSDaemon/WampAPI-Specification/pulls> and open a new pull request with your changes.
...
* Go to the issue tracker
  and [filter open issues by the `support` label](https://github.com/KSDaemon/wampy.js/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
* Be kind and patient with users -- often, folks who have run into confusing things might be upset or impatient. This is
  ...
  CoC, [refer to the Code of Conduct](.github/CODE_OF_CONDUCT.md) to resolve the conflict).
...
In order to label
issues, [open up the list of unlabeled issues](https://github.com/KSDaemon/WampAPI-Specification/issues?q=is%3Aopen+is%3Aissue+no%3Alabel)
...
* Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping us if and when you're ready to
  resume this. See <https://github.com/KSDaemon/WampAPI-Specification/blob/latest/CONTRIBUTING.md#clean-up-issues-and-prs> for more
  details."
